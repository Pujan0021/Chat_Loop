...
const NoChatHistoryPlaceholder = ({ name }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-6">
      <div className="w-16 h-16 ~ from-cyan-500/20 to-cyan-400/10 rounded-full flex items-center justify-center mb-5">
      ...
      <div className="flex flex-col space-y-3 max-w-md mb-5">
        ...
        <div className="h-px w-32  from-transparent via-cyan-500/30 to-transparent mx-auto"></div>
      </div>
